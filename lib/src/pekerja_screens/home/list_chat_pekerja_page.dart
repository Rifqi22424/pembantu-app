...
class ListChatPekerjaPage extends StatefulWidget {
  const ListChatPekerjaPage({super.key});

  @override
  State<ListChatPekerjaPage> createState() => _ListChatPekerjaPageState();
}

class _ListChatPekerjaPageState extends State<ListChatPekerjaPage>
  ...
  Padding allMessage() {
    return const Padding(
      padding: EdgeInsets.only(left: 18.0, bottom: 4),
      child: Align(
